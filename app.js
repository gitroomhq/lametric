    ...
    frames: [
      ...
      },
      {
        goalData: {
          ...
          unit: lastSubs === 0 ? "" : lastSubs > active.length ? "-" : "+",
        },
        icon: 52106,
        duration: 5000,
      },
      {
        goalData: {
          ...
          unit: lastTrials === 0 ? "" : lastTrials > trialing.length ? "-" : "+",
        },
        icon: 49835,
        duration: 5000,
      },
    ...
    frames: [
      {
        goalData: {
          ...
          unit: lastGitHubStars === 0 ? "" : lastGitHubStars > +stars ? "-" : "+",
        },
        icon: 14925,
      },
    ],
